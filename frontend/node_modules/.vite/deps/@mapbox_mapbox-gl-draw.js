...
function comparator(a, b) {
  ...
  if (score === 0 && a.geometry.type === geojsonTypes.POINT) {
...
function options_default(options = {}) {
  ...
  withDefaults.styles = sourcedStyles.concat(addSources(unsourcedStyles, "cold")).concat(addSources(unsourcedStyles, "hot"));
  return withDefaults;
}
